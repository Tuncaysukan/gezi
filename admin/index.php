    ...
    <div class="admin-wrapper">
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <nav class="sidebar-nav">
                <ul>
                    ...
                    <li class="nav-item">
                        <a href="#stories" class="nav-link" data-page="stories">
                    ...
                    <li class="nav-item">
                        <a href="#seo" class="nav-link" data-page="seo">
        ...
        <main class="admin-content">
            ...
            <div class="page-content" id="pageContent">
                <!-- Dashboard sayfası varsayılan olarak yüklenecek -->
                <div class="content-page active" id="dashboard-page">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-lg-4">
                            <div class="card">
                                <div class="card-header">
                                    <h5>Popüler Gönderiler</h5>
                                </div>
                                <div class="card-body">
                                    <div class="popular-post">
                                        <h6>İstanbul'un Gizli Bahçeleri</h6>
                                        <small>1,245 görüntülenme</small>
                                    </div>
                                    <div class="popular-post">
                                        <h6>Kapadokya'da Bir Gün</h6>
                                        <small>856 görüntülenme</small>
                                    </div>
                                    <div class="popular-post">
                                        <h6>Antalya Kanyonları</h6>
                                        <small>723 görüntülenme</small>
                                    </div>
                                </div>
                            </div>
                        </div>
